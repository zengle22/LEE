...
tags: []
properties: {}
frozen_at: '2026-03-13T10:25:14.564032'
---
...
实现 reverse workflow 对现行 SSOT 文档链的完整承接与逆向升级，确保形式化对象治理边界清晰。
...
- 为 UI / TECH / TASK / TESTSET / TC / REPORT / BUG / EVI 生成除 seed、view、handoff/index 外的产出
