...
properties:
  contract_key: epic
  identity_kind: ssot
frozen_at: '2026-03-13T13:50:20.044387'
---

epic_id: EPIC-SRC-DRAFT-001
title: reverse-epic-feat-l3 对齐现行 SSOT 链逆向升级
goal: 构建逆向工作流能力，使其能够完整承接并生成符合现行 SSOT 规范的文档链，确保 SRC/EPIC/FEAT 对象物化路径与 canonical 目录一致。
scope:
...
- 为 UI / TECH / TASK / TESTSET / TC / REPORT / BUG / EVI 生产除 seed、view、handoff/index
  之外的产物
...
- 按 formal object 类型拆分 (SRC/EPIC/FEAT)
- 按产物类型拆分 (seed/view/handoff/index)
- 按工作流阶段拆分 (解析/转换/物化/验证)
ssot:
  identity_kind: ssot
  ssot_type: EPIC
  version: 1.0.0
