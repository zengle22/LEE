...
> 📜 本文档包含需要人工决策的歧义点。工作流已暂停，等待您完成决策后继续。
...
| 状态 | 含义 |
|------|------|
| 📝 PENDING_DECISION | 待决策 - 等待人类决策 |
| ✅ COMPLETED | 已完成 - 所有决策已完成 |
| 🔄 PROCESSING | 处理中 - Agent 正在处理决策结果 |
...
| 版本 | 日期 | 变更内容 | 变更人 |
|------|------|----------|--------|
| 1.0 | {{generated_at}} | 初始版本创建 | requirement-analyzer |
{{#each change_log}}
