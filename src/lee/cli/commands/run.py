...
_RUN_COMMAND_EPILOG = (
    ...
    "  product.feat-to-delivery-prep  冻结 FEAT 转交付准备\n"
    "  product.feat-to-release   Delivery Prep 转 RELEASE draft\n"
    "  product.feat-to-plan      Delivery Prep 转 RELEASE/DEVPLAN/TESTPLAN\n"
    "  dev.release-to-devplan    RELEASE draft 转 DEVPLAN\n"
    "  qa.release-to-testplan    RELEASE draft 转 TESTPLAN\n"
    ...
    "  lee run product.feat-to-plan --spec delivery-plan-input.yaml\n"
